jQuery("#simulation")
  .on("mouseenter dragenter", ".s-e37926ee-d0f1-408f-b1f4-458b5063e27a .mouseenter", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "target": [ "#s-e37926ee-d0f1-408f-b1f4-458b5063e27a #s-Button_1" ],
                    "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-e37926ee-d0f1-408f-b1f4-458b5063e27a #s-Text_3" ],
                    "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-e37926ee-d0f1-408f-b1f4-458b5063e27a #s-Text_1" ],
                    "attributes": {
                      "filter": " brightness(70.0%)"
                    }
                  } ],
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "target": [ "#s-e37926ee-d0f1-408f-b1f4-458b5063e27a #s-Text_2" ],
                    "attributes": {
                      "filter": " brightness(70.0%)"
                    }
                  } ],
  ...
  .on("mouseleave dragleave", ".s-e37926ee-d0f1-408f-b1f4-458b5063e27a .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(jimUtil.isAlternateModeActive()) return;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
